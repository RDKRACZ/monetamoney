...
public class ChunksPage extends Screen implements IStatusable {
    ...
    protected void init() {
        ...
        this.renderables.add(this.list);
    }
        ...
        class ChunkEntry extends ObjectSelectionList.Entry<ChunkEntry> {
            ...
            public boolean mouseClicked(double mouseX, double mouseY, int button) {
                if (button == 0) {
                    ...
                    message.append(chunkLoader.owner + " | " + chunkLoader.dimensionKey + " | " + new ChunkPos(chunkLoader.pos) + " | " + chunkLoader.pos + " | " + chunkLoader.status.name);
